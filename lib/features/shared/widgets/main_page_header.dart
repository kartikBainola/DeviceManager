...
import 'package:device_manager/features/shared/responsiveness/main_page_header_responsive.config.dart';
import 'package:device_manager/styles/styles.dart';

class MainPageHeader extends StatelessWidget {
  final String title;
  final Widget icon;
  const MainPageHeader({required this.title, required this.icon, super.key});
