...
import 'package:device_manager/features/devices/presentation/widgets/add_device_workflow/device_type_selection_panel.dart';
                  ...
                  children: [
                    ...
                    DropdownButtonHideUnderline(
                      child: DropdownButton<OutletModel>(
                          ...
                          value: outletValue,
                          items: outletList
                              .map<DropdownMenuItem<OutletModel>>((outlet) {
                          ...
                          onChanged: (OutletModel? value) {
                            ref.read(outletValueProvider.notifier).state =
                                value!;
                          }),
                    ),
                  ],
